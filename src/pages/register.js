    ...
    <Layout title='Register User' keywords='{undefined}' description='{undefined}' >
       <div className='my-20 h-screen'>
        ...
        <div className='flex-1 text-xs sm:text-sm flex flex-col justify-cener items-center gap-2 sm:gap-4'>
              ...
              <input type="text" value={username} onChange={(e) => setFname(e.target.value)} placeholder='First Name' className='outline-none duration-300 border-b-2 border-solid border-white focus:border-cyan-300 text-slate-900 p-2 w-full max-w-[40ch]' />
